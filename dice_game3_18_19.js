...
function runGame(){
	console.log("Welcome to my game! This is a 2 player game. Each player will roll a total of 5 times. 6 dice will roll each time. The total of all rolls will result in a players score." +
				 " Highest score wins.");  
	//rules maybe
